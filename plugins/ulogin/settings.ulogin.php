		...
		function print_admin_page() {
			...
			if(isset($_POST['update_uLoginPluginSettings'])) {
				...
				if(isset($_POST['uloginLabel']))
					$uLoginOptions['label'] = sanitize_text_field($_POST['uloginLabel']);

				if(isset($_POST['uloginForceFields']))
					$uLoginOptions['force_fields'] = sanitize_text_field($_POST['uloginForceFields']);
				...
				if(isset($_POST['uloginID1']))
					$uLoginOptions['uloginID1'] = sanitize_text_field($_POST['uloginID1']);

				if(isset($_POST['uloginID2']))
					$uLoginOptions['uloginID2'] = sanitize_text_field($_POST['uloginID2']);

				if(isset($_POST['uloginID3']))
					$uLoginOptions['uloginID3'] = sanitize_text_field($_POST['uloginID3']);
				...
				if(isset($_POST['uloginBackurl']))
					$uLoginOptions['backurl'] = esc_url_raw($_POST['uloginBackurl']);
			...
			$form = str_replace('{BACKURL_VALUE}', esc_url($uLoginOptions['backurl']), $form);
...
PHP_EOL;
		...
		function get_div_panel($place = 0, $with_label = true, $id = '', $div_only = false) {
			...
			$popupCss = '';
			if(isset($uloginOptions['uloginPopupCss'])){
